...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2018 a las 16:01:12
...
CREATE TABLE IF NOT EXISTS `caja_conceptos_generales` (
  `id` int(11) NOT NULL,
  `nombre` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `idanulo` int(11) DEFAULT '0'
...
CREATE TABLE IF NOT EXISTS `centro_area` (
  `id` int(11) NOT NULL,
  `nombre` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `centro_costos` (`idcentrocostos`, `centrocostos`, `idanulo`, `idciudad`) VALUES
(1, 'PRINCIPAL', 0, 1),
(2, 'IGLESIA SANTA LUCIA', 0, 3);
...
--
CREATE TABLE IF NOT EXISTS `comprobante_banco` (
...
CREATE TABLE IF NOT EXISTS `comprobante_egreso` (
...
CREATE TABLE IF NOT EXISTS `detalles_comprobante_egreso` (
...
(2, 3, 20000, 234567, 3, '2018-10-07 10:33:48', 'archivos/07173396.png', 0, 20000, 1, 3),
...
CREATE TABLE IF NOT EXISTS `diezmo_pastores` (
  `id` bigint(20) NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `recibo_caja_banco` (
`idrecibo` bigint(20)
,`fecha` date
,`fecha_creacion` datetime
,`concepto` varchar(50)
...
--
CREATE TABLE IF NOT EXISTS `recibo_caja_caja` (
`idrecibo` bigint(20)
,`fecha` date
,`fecha_creacion` datetime
,`concepto` varchar(50)
...
--
ALTER TABLE `bancos`
  ADD PRIMARY KEY (`id`), ADD KEY `index_idcomprobante` (`idcomprobante`) USING BTREE, ADD KEY `index_idcaja` (`idcaja`) USING BTREE;
...
ALTER TABLE `caja_conceptos_generales`
  ADD PRIMARY KEY (`id`), ADD KEY `nombre` (`nombre`);

--
-- Indices de la tabla `centro_area`
--
ALTER TABLE `centro_area`
  ADD PRIMARY KEY (`id`), ADD KEY `fk_area_costo` (`idarea`);
...
ALTER TABLE `ciudades`
  ADD PRIMARY KEY (`idciudad`), ADD KEY `FK_deptarmento_ciudad` (`iddepartamento`);

--
-- Indices de la tabla `comprobante_egreso`
--
ALTER TABLE `comprobante_egreso`
  ADD PRIMARY KEY (`idcomprobante`), ADD KEY `Fk_comprobante_egreso_centro_costos` (`idcentrocostos`), ADD KEY `fecha_creacion` (`fecha_creacion`);
...
ALTER TABLE `departamento`
  ADD PRIMARY KEY (`id`), ADD KEY `fk_pais_dep` (`idpais`);

--
-- Indices de la tabla `detalles_comprobante_egreso`
--
ALTER TABLE `detalles_comprobante_egreso`
  ADD PRIMARY KEY (`iddetalle`), ADD KEY `index_idtercero` (`idtercero`), ADD KEY `index_idconcepto` (`idconcepto`), ADD KEY `index_idcomprobanteegreso` (`idcomprobanteegreso`) USING BTREE;

--
-- Indices de la tabla `detalle_recibo_caja`
--
ALTER TABLE `detalle_recibo_caja`
  ADD PRIMARY KEY (`iddetalle_recibo`), ADD KEY `index_idtercero` (`idtercero`), ADD KEY `index_tipo_ingreso` (`idtipoingreso`), ADD KEY `fk_recibocajadetalle_rc` (`idrecibocaja`);

--
-- Indices de la tabla `diezmo_pastores`
--
ALTER TABLE `diezmo_pastores`
  ADD PRIMARY KEY (`id`), ADD KEY `fk_diezmo_pastor` (`idpastor`);
...
ALTER TABLE `pastores`
  ADD PRIMARY KEY (`cedula`), ADD KEY `fk_tipoid` (`tipoid`), ADD KEY `fk_pastor_centro_costos` (`centro_costo`);

--
-- Indices de la tabla `recibo_caja`
--
ALTER TABLE `recibo_caja`
  ADD PRIMARY KEY (`idrecibo`), ADD KEY `indexcentrocostos` (`idcentrocostos`);

--
-- Indices de la tabla `terceros`
--
ALTER TABLE `terceros`
  ADD PRIMARY KEY (`idtercero`), ADD UNIQUE KEY `identificacion` (`identificacion`), ADD KEY `fk_terceros_ciudad` (`idciudad`), ADD KEY `fk_usuarios_creacion` (`usuariocreacion`), ADD KEY `fk_terceros_tipodi` (`tipo_id`);
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `username` (`username`), ADD UNIQUE KEY `email` (`email`), ADD UNIQUE KEY `indice_usuarios` (`id`), ADD KEY `index_centrocostos` (`centrocosto`), ADD KEY `username_2` (`username`);
